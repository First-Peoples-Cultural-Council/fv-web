import { extractTextFromHtml, convertStateToVisibility } from 'common/stringHelpers'
...
function dictionaryCrudDataAdaptor(data) {
  ...
  if (hasBeenEditedInv2) {
    return {
      ...
      categories: properties?.['fv-word:categories'] || properties?.['fv-phrase:phrase_books'] || [],
    ...
    */
    ...
    const partOfSpeech =
      properties?.['fv-word:part_of_speech'] === 'basic' ? null : properties?.['fv-word:part_of_speech']
