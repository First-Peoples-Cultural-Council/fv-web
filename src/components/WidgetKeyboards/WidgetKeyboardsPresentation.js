...
function WidgetKeyboardsPresentation({ header, urls }) {
  return (
    <div id="WidgetKeyboardsPresentation" className="mx-auto bg-white py-3">
      <div className="border border-charcoal-200 mx-auto p-6 md:p-10 my-4 max-w-5xl rounded-xl">
