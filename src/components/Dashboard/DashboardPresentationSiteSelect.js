...
function DashboardPresentationSiteSelect({ sites, site }) {
  return sites?.length > 1 ? (
    ...
    >
      ...
      >
        <MenuItems className="z-10 mx-3 origin-top absolute right-0 left-0 mt-1 rounded-lg shadow-lg bg-white ring-1 ring-black/50 divide-y divide-charcoal-100 focus:outline-hidden">
          {sites?.length > 1 &&
