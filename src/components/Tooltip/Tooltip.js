...
function Tooltip({ children, hide, message, position = 'left-1/2 bottom-9' }) {
  return (
        ...
        >
          {!hide && (
            <div className="flex max-w-32 flex-col items-center">
              <div className="max-w-32 text-wrap rounded-sm bg-blumine-800 p-2 text-center text-xs text-white">
                {message}
              </div>
