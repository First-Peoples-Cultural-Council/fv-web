...
function SiteAppsPresentation() {
  ...
  return (
    <div
      ...
      className="max-w-7xl mx-auto pt-2 pt-md:pt-4 lg:pt-8 bg-white"
    >
      <SiteDocHead titleArray={['Mobile App']} />
      <div className="px-4 sm:px-6 lg:px-8 space-y-4 md:space-y-6 lg:space-y-10">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl lg:text-center">
              ...
              <p className="mt-4 sm:mt-6 text-lg/8 text-charcoal-700">
                ...
                mobile app. The app pulls dictionary entries, songs, and stories
                directly from FirstVoices and always has the latest content. The
                app can be installed directly from the web.
              </p>
            </div>
        ...
        <section className="justify-center max-w-5xl px-4 lg:px-0 mx-auto text-charcoal-700">
          <div className="space-y-4 py-4 md:py-8">
            ...
            <div className="mt-2 text-charcoal-700">
              <p className="mt-4 sm:mt-6 text-lg/8">On Android (Chrome)</p>
              <ol className="list-inside list-decimal text-base/7 py-2">
                <li>
              ...
              <ol className="list-inside list-decimal text-base/7 py-2">
                ...
                <li>Tap the three-dot menu (⋯) in the bottom right corner.</li>
              ...
              <ol className="list-inside list-decimal text-base/7 py-2">
                ...
                <li>
                  ...
                  (often a computer screen with a downward arrow, or a plus
                  sign).
                </li>
              ...
              <ol className="list-inside list-decimal text-base/7 py-2">
                ...
                <li>
                  Go to the menu bar and select &quot;File&quot; &gt; &quot;Add
                  to Dock&quot;.
                </li>
              </ol>
            </div>
            <p className="text-lg/8 text-charcoal-700">
              Find more detailed instructions on how to install our app on your
              device here:{' '}
              <a
                className="inline-url"
                target="_blank"
