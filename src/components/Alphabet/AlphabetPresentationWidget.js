...
function AlphabetPresentationWidget({ characters, onCharacterClick, links, selectedData }) {
  return characters ? (
    <section className="py-3 md:py-6 bg-white" data-testid="AlphabetPresentationWidget">
