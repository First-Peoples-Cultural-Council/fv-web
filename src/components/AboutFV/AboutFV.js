      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-fv-charcoal space-y-4 text-center py-8">
          ...
          <div className="max-w-4xl mx-auto text-fv-charcoal space-y-4 text-center py-8">
            ...
            <p className={paraStyle}>
              Member groups represent over 50 Indigenous nations, bands and
              other non-profit organizations. The content they create, called
            ...
            <p className={paraStyle}>
              While most language sites on FirstVoices are visible to the
              public, members can choose to create content that can be accessed
              only through a secure login. Examples of this type of content
              include stories, sacred songs, prayers, ceremonial regalia, or
              dances seen only in community ceremonies.
            </p>
            <h2 className={headerStyle}>
              Elders and youth team up for language preservation
            </h2>
            <p className={paraStyle}>
              The FirstVoices team works with experienced language educators,
              band councils and language communities to plan revitalization
              programs. Using digital recording, many of these Elders&lsquo;
              voices are preserved and accessed online by computer, tablet, or
              mobile phone. Younger, tech-savvy community members become engaged
              through training in professional audio recording and archiving
              techniques. We can also help with physical archives, such as audio
              cassettes, photos, and written sources which can be digitally
              archived through Federal and Provincial grant programs.
            </p>
            ...
            <ul className="list-outside list-disc text-left px-16">
              <li>
                ...
                create, edit, host, and maintain content on their own
                interactive &ldquo;language site,&ldquo; featuring a suite of
                online tools such as dictionary, custom search, games, Kids
                Area, and more.
              </li>
              <li>
                FirstVoices apps - Interactive dictionary apps for Android and
                iOS, which pull content from FirstVoices language sites. The
                apps contain text, audio, image and video content and are
                available as free downloads from the iTunes and Google Play
                stores.
              </li>
              <li>
                FirstVoices keyboards - Keyboard software designed in
                partnership between language communities and the Keyman keyboard
                development team, downloadable on Mac and PC computers.
              </li>
              <li>
                FirstVoices keyboard app - Keyboard software for all FirstVoices
                keyboards within one easy to use app. Once the FirstVoices
                keyboard app is installed on a mobile device, any one of the
                100+ custom keyboards can be activated. Users then are able to
                select their keyboard(s) of choice within their email, social
