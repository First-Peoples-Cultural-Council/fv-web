        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-charcoal-900 space-y-4 py-8 text-pretty">
            ...
            <p className={paraStyle}>
              ...
              onto their FirstVoices language sites can be accessed through
              mobile and desktop apps. FirstVoices apps pull content directly
              from community language sites and function with offline
              capabilities.
            </p>
            <p>
              The apps are compatible with most phones, tablets, and laptops and
              can be installed directly from their sites. Click the link below
              for the app you wish to install and then select “Install” or “Add
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        type="button"
                        className="bg-scarlet-800 hover:bg-scarlet-900 text-white px-4 py-2 rounded-md w-full h-24 md:h-16"
                      >
                        <span>Go to {title} App</span>
                      </button>
                    </a>
                  </div>
                )
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            ...
            <p className={paraStyle}>
              ...
              no longer being updated and may not be installable on all devices.
            </p>
