...
function Keyboards() {
  const headerStyle = 'text-lg md:text-xl font-bold text-blumine-800'
  const paraStyle = 'text-base text-charcoal-900'
  const numberedListStyle =
    'list-outside list-decimal text-left px-6 sm:px-10 md:px-16'
  const listStyle = 'list-outside list-disc text-left px-6 sm:px-10 md:px-16'
        ...
        <div className="max-w-4xl mx-auto text-charcoal-900 space-y-6 md:space-y-8 pt-2 pb-6 md:py-8">
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              Many First Nations languages require a number of characters that
              are not available on the standard English keyboard. To type these
              characters, you must install:
            </p>
            <ol className={numberedListStyle}>
              <li>
            ...
            <p className={paraStyle}>
              ...
              the Unicode standard, which is the system that allows all
              characters to be displayed properly and consistently across
              different devices and the internet. Earlier PC and Mac operating
              systems do not support Unicode technology sufficiently. Even if
              you are using a recent operating system, not all of your
              applications will necessarily be Unicode compliant.
            </p>
          </section>
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              ...
              However, many installers will prompt you about data security
              before installing any software that affects your keyboard.
            </p>
          </section>
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              ...
              character or letter should show up on the screen. Some common
              fonts include Times New Roman, Arial, and Calibri.
            </p>
            <p className={paraStyle}>
            ...
            <ol className={numberedListStyle}>
              ...
              <li>
                ...
                <ul className={listStyle}>
                  <li>
                    Double click the font file and Font Viewer will open a
                    preview of the font
                  </li>
                  <li>
                  ...
                  <li>
                    Repeat for each of the four font files in order to be able
                    to use regular, bold, italic, and bold+italic fonts
                  </li>
                </ul>
                For Mac computers
                <ul className={listStyle}>
                  <li>
                    Double click the unzipped font file and Font Book will open
                    a preview of the font
                  </li>
                  <li>
                    Click &ldquo;Install Font&ldquo; at the bottom of the
                    preview window
                  </li>
                </ul>
              </li>
              <li>
                You may need to restart your computer for the font to be
                available in all applications
              </li>
            </ol>
            <p className={paraStyle}>
              Use caution with custom fonts. If you are using a custom font to
              type special characters in your language, you may be unable to
              paste your text in new applications or type correctly on websites
              like Facebook. This means your font is not Unicode-compliant, and
              you may be at risk of losing your language data if the font is
              ever corrupted or lost. To see our fonts and keyboards page on the
          ...
          <section className={sectionStyle}>
            ...
            <div className="flex md:items-center space-x-4 sm:space-x-10">
              <img
                src={FVKeyboards}
              ...
              <p className={paraStyle}>
                ...
                on mobile devices, such as a phone or tablet, you can download
                the FirstVoices Keyboards app on for{' '}
                <a
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              Installing the FirstVoices keyboard for your language on a
              computer will be done through a keyboard software called Keyman.
              Go to{' '}
              <a
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              If the model of your Chromebook has Tablet Mode, then you can use
              the FirstVoices Keyboard App from the Google Play store when the
              Chromebook is in tablet mode.
            </p>
            <p className={paraStyle}>
              For Chromebooks that do not have Tablet Mode, or if you are not
              able to install the keyboard for any other reason, you can access
              a no-install version of the keyboard right in your web browser on{' '}
              <a
                href="https://keyman.com/"
                className="inline-url"
                target="_blank"
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              ...
              language site, you can see a ist of keyboards corresponding to
              FirstVoices language sites on our knowledge base{' '}
              <a
            ...
            <p className={paraStyle}>
              ...
              community doesn&lsquo;t have an existing FirstVoices Keyman
              keyboard that suits your unique orthography, the FirstVoices team
              can develop one for you! Click here to read about how to{' '}
              <a
          ...
          <section className={sectionStyle}>
            ...
            <p className={paraStyle}>
              ...
              functions with offline capabilities. The apps are updated
              throughout the year in order to ensure that the latest content
              that has been added to a language site also appears on the app.
            </p>
          </section>
        </div>
      </div>
