                ...
                >
                  <div className="relative">
                    ...
                    <Transition
                      ...
                      afterLeave={() => setQuery('')}
                    >
                      <Combobox.Options className="focus:outline-none h-32 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5">
